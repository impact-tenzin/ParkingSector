...
urlpatterns = patterns('',
    ...
    url(r'^actualiseNumber/', 'home.views.increase_number'),
	url(r'^checkForLogin/', 'home.views.is_logged_in'),
	url(r'^bookParkingSpot/', 'parkingclient.views.book_parkingspot'),
	...
	url(r'^deleteBooking/', 'parkingclient.views.delete_booking'),
