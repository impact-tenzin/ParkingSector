...
urlpatterns = patterns('',
    ...
    url(r'^register/', 'parkingclient.views.register_user'),
    ...
    url(r'^pricelist/', 'parkingclient.views.render_price_list_page'),
    url(r'^getPriceList/', 'parkingclient.views.get_price_list'),
    ...
    url(r'^actualiseAvailableSpaces/', 'parkingclient.views.actualise_available_spaces'),
